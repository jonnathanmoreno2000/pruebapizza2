...
namespace pruebapizza2
{
	...
	public partial class LinkVentaDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteVenta(Venta instance);
		...
		public LinkVentaDataContext() : 
				base(global::pruebapizza2.Properties.Settings.Default.masterConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public LinkVentaDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LinkVentaDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LinkVentaDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LinkVentaDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCreated();
    partial void OnfechaChanging(long value);
    ...
    partial void OnidClienteChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_fecha", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		public long fecha
		{
			get
			{
